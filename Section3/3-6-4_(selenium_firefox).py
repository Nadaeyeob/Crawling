...
firefox_options.add_argument('--headless') # CLI 환경으로 만듬

driver = webdriver.Firefox(firefox_options = firefox_options, executable_path=r'C:\Crawling\Section3\webdriver\firefox\geckodriver')
