...
class Main(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # BGM
        # 하기와 같이 코드할 경우 BGM이 main thread로 작동되면서, Youtube 검색 시 작업이 멈춤
        # Thread를 분리하여 멈추지 않게끔 함
        # QSound.play('C:/Users/sw991/Crawling/Section6/resource/intro.wav')
    ...
    def initIntroThread(self):
        ...
        # Worker To Thread 전환
        self.IntroObj.moveToThread(self.Introthread) # moveToThread - QObject에서 제공함
        # Signal 연결
